...
public class FileSystemBaseConnectInfoAdapter extends AbstractINFASDKAdapter  {
    ...
    public FileSystemBaseConnectInfoAdapter(){
        adpInfo = new SDKAdapterInfo();
        adpInfo.setAdapterType(SDKAdapterTypeEnum.ENTERPRISE_APP);
        adpInfo.setResourceBundleName("i18n/CON1Bundle");
        adpInfo.setConnectionTypeDesc("FileSystem");
        adpInfo.setConnectionDisplayName("FileSystem");
    ...
    public void updateConnectInfoAttributeTypes(SDKConnectAttributeType attrib){
        ...
        if (attribName.equalsIgnoreCase("filename")) {
            attrib.setAttributeCLIDisplayName("filename");
        }
    ...
    private SDKConnectionConsumerGroup createPage1Group1DFLT(){
        ...
        group.getConnInfoPresentationControls().add(
                	createAttributePresentation("filename", "FILENAME", "FILENAME_TOOLTIP",
                	                            true, false, false));
