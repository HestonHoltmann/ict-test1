...
import com.heston.adapter.con1.account.runtime.capability.semantic.auto.SAAccountCallCapabilityAttributesExtension;
...
public class MAAccountCallCapabilityAttributesExtension extends MD_ModelExtensionCallCapAttributes implements OM_Obj
{
    ...
    public boolean validateAll(boolean recurse, ObjectManagerContext ctx, MetadataObject currentObj, MetadataObject containerObj) throws SL_ValidationException
    {
        ...
        if(!super.validateAll(recurse, ctx, currentObj, containerObj))
            rc = false;
        SAAccountCallCapabilityAttributesExtension semObj = (SAAccountCallCapabilityAttributesExtension)currentObj;
