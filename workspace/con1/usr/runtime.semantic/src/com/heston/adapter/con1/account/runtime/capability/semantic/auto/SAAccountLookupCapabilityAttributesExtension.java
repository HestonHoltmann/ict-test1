...
import com.heston.adapter.con1.account.runtime.capability.AccountLookupCapabilityAttributesExtension;
...
import com.heston.adapter.con1.account.runtime.capability.objectmanager.auto.MAAccountLookupCapabilityAttributesExtension;
import com.heston.adapter.con1.account.runtime.capability.CapabilityIFactory;
import java.util.Set;
import com.heston.adapter.con1.account.runtime.capability.semantic.iface.SEMAccountLookupCapabilityAttributesExtension;
...
/** 
  * Code generated semantic layer wrapper for AccountLookupCapabilityAttributesExtension
  */
@SuppressWarnings("unused") //$NON-NLS-1$
public class SAAccountLookupCapabilityAttributesExtension extends SAD_ModelExtensionLookupCapAttributes implements SL_Obj, SEMAccountLookupCapabilityAttributesExtension
{
    ...
    public SAAccountLookupCapabilityAttributesExtension()
    {
        super();
    }

    /** Get underlying IMF object. Reserved for semantic layer use only */
    public AccountLookupCapabilityAttributesExtension _get_imfObject()
    {
        return (AccountLookupCapabilityAttributesExtension)_imfObject;
    }

    /** Create new instance of Semantic layer object (inc. associated IMF object) */
    public static SAAccountLookupCapabilityAttributesExtension newObj(SL_ContainerObj root) throws SL_Exception
    {
        AccountLookupCapabilityAttributesExtension imfObj = CapabilityIFactory.I_INSTANCE.createAccountLookupCapabilityAttributesExtension();
    ...
    protected static SAAccountLookupCapabilityAttributesExtension newObjFrom(AccountLookupCapabilityAttributesExtension imfObj, SL_ContainerObj root) throws SL_Exception
    {
        SAAccountLookupCapabilityAttributesExtension newObj = (SAAccountLookupCapabilityAttributesExtension)root.get_factory().newSemanticClass(AccountLookupCapabilityAttributesExtension.class, root.get_factory().getClass().getClassLoader());
        newObj.rootObj = root;
        newObj._validator = (MAAccountLookupCapabilityAttributesExtension)root.get_factory().newObjectmanagerClass(AccountLookupCapabilityAttributesExtension.class, root.get_factory().getClass().getClassLoader());
    ...
    public static  SAAccountLookupCapabilityAttributesExtension getSemanticObject(AccountLookupCapabilityAttributesExtension imfObj)
    {
        SAAccountLookupCapabilityAttributesExtension rc = (SAAccountLookupCapabilityAttributesExtension)Utils.getObjectExtension(imfObj);
        if(rc==null) {
            SL_ContainerObj container = Utils.getSemanticContainer(imfObj);
            rc = (SAAccountLookupCapabilityAttributesExtension)Utils.invoke_buildSemanticLayer(imfObj, container, container.get_factory(), container.getClass().getClassLoader());
        }

        return rc;
    }

    public MAAccountLookupCapabilityAttributesExtension _get_objectmanager()
    {
        return (MAAccountLookupCapabilityAttributesExtension)_validator;
    }

    public AccountLookupCapabilityAttributesExtension getAdaptee()
    {
    ...
    {
        String rc = "SAAccountLookupCapabilityAttributesExtension " +" (hashCode="+hashCode()+")";
        return rc;

    }

    /** Builds semantic layer objects for existing IMF model */
    public static SAAccountLookupCapabilityAttributesExtension buildSemanticLayer(AccountLookupCapabilityAttributesExtension imfObj, SL_ContainerObj root) throws SL_Exception
    {
        SAAccountLookupCapabilityAttributesExtension me = newObjFrom(imfObj, (SL_ContainerObj)root);
    ...
    public SAAccountLookupCapabilityAttributesExtension _buildSemanticLayerRecurse(SL_ContainerObj root) throws SL_Exception
    {
    ...
    public  void _shallowCopyInternal(SL_Obj fromObjArg) {
        SAAccountLookupCapabilityAttributesExtension fromObj = (SAAccountLookupCapabilityAttributesExtension)fromObjArg;
    ...
    public SL_Obj _shallowCloneInternal(SL_ContainerObj trgContainer) {
        SAAccountLookupCapabilityAttributesExtension newObj = (SAAccountLookupCapabilityAttributesExtension) this._newObj_NonStatic((SL_ContainerObj)trgContainer);
    ...
    /** 
      ...
      */
    public SAAccountLookupCapabilityAttributesExtension _deepCloneInternal(SL_ContainerObj trgContainer) {
        SAAccountLookupCapabilityAttributesExtension newObj = (SAAccountLookupCapabilityAttributesExtension) this._newObj_NonStatic((SL_ContainerObj)trgContainer);
        if(trgContainer.get_patchRefsMap()!=null) 
            trgContainer.get_patchRefsMap().put(this, newObj);
    ...
    /** 
      ...
      */
    public SAAccountLookupCapabilityAttributesExtension deepClone(SL_ContainerObj trgContainer) {
        SAAccountLookupCapabilityAttributesExtension newObj = (SAAccountLookupCapabilityAttributesExtension) this._newObj_NonStatic((SL_ContainerObj)trgContainer);
        if(trgContainer.get_patchRefsMap()!=null) 
            trgContainer.get_patchRefsMap().put(this, newObj);
    ...
    /** 
      ...
      */
    public SAAccountLookupCapabilityAttributesExtension _newObj_NonStatic(SL_ContainerObj trgContainer) throws SL_Exception
    {
