...
public class Con1AccountOperationAdapter extends DataSourceOperationAdapter  {

    private Logger logger = null;

    public Con1AccountOperationAdapter(Logger infaLogger){
    ...
    private int initDataOperationRead(DataSourceOperationContext dsoHandle, MetadataContext connHandle, BasicProjectionView projection){
    			...
    			//sample code to show connection to data source

        		/* Con1DataConnection conn = new Con1DataConnection(logger);
        		conn.connect(connHandle);
        		Object metadataConn = conn.getNativeConnection();
        		java.sql.Connection sqlConn = (Connection) metadataConn; */
        		...
        		// TODO: Add code here to initialize
        		// before read is executed
    ...
    private int deinitDataOperationRead(DataSourceOperationContext dsoHandle, MetadataContext connHandle, BasicProjectionView projection){
        		...
        		/* Con1AccountDataConnection conn = new Con1AccountDataConnection(logger);
        		conn.connect(connHandle);
        		Object metadataConn = conn.getNativeConnection();
        		java.sql.Connection sqlConn = (Connection) metadataConn; */
        		...
        		// TODO: Add code here to de-initialize
        		// after read is executed
