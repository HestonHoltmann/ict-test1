...
public class Con1AccountPlugin extends AdapterPlugin  {
    ...
    public int initPlugin(PluginInfo pluginInfo, InfaUtils infaUtils){
    		...
    		pluginInfo.setPluginDescription("heston test con1 with ict in github - to test project clone and import accross dev machines that differ in os and how base tools installed by users");
    		pluginInfo.setPluginName("com.heston.adapter.con1.libraryInfo.ACCOUNTCON1LIBRARYINFO");
    ...
    public Connection createConnection(){
    	return new Con1AccountDataConnection(logger);
    }
    ...
    public DataAdapter getDataAdapter(){
    	return new Con1AccountDataAdapter();
    }
    ...
    public DataSourceOperationAdapter getDataSourceOperationAdapter(){
    	return new Con1AccountOperationAdapter(logger);
    }
