...
package com.heston.adapter.con1.account.metadata.objectmanager.auto;
...
public class MAAccountFieldExtensions extends MAL_ModelExtensionFieldBase implements OM_Obj
{
    ...
    public boolean validateAll(boolean recurse, ObjectManagerContext ctx, MetadataObject currentObj, MetadataObject containerObj) throws SL_ValidationException
    {
        ...
        if(!super.validateAll(recurse, ctx, currentObj, containerObj))
            rc = false;
        SAAccountFieldExtensions semObj = (SAAccountFieldExtensions)currentObj;
