 ...
 * Generation time: 
 */
package com.heston.adapter.con1.runtime.aso.impl;
...
implements com.heston.adapter.con1.runtime.aso.AsoIPackage {

    /**
     * The generated Serial Version UID.
     */
      private static final long serialVersionUID = 7254453655649936610L;
    ...
    private AsoIPackageImpl() {
        super(com.heston.adapter.con1.runtime.aso.AsoIFactory.I_INSTANCE);
     ...
     */
     public static com.heston.adapter.con1.runtime.aso.AsoIPackage init() {
       synchronized(com.informatica.imf.icore.IMFRuntime.getInstance().getIMFRegistryLockObject()) {
          LOGGER.log(Level.FINE, "Initialization of com.heston.adapter.con1.runtime.aso.AsoIPackage: enter 'init()'");
            com.informatica.imf.icore.IMFRuntime imfRuntime = com.informatica.imf.icore.IMFRuntime.getInstance();
          if (imfRuntime.isPackageRegistered(com.heston.adapter.con1.runtime.aso.AsoIPackage.I_QUALIFIED_NAME)) {
            LOGGER.log(Level.FINE, "Initialization of com.heston.adapter.con1.runtime.aso.AsoIPackage: already initialized");
            return (com.heston.adapter.con1.runtime.aso.AsoIPackage)
              imfRuntime.getIPackageForName(com.heston.adapter.con1.runtime.aso.AsoIPackage.I_QUALIFIED_NAME);
          }

          // Create and register package
          AsoIPackageImpl theComHestonAdapterCon1RuntimeAsoIPackage = (AsoIPackageImpl)
              new com.heston.adapter.con1.runtime.aso.impl.AsoIPackageImpl();

          theComHestonAdapterCon1RuntimeAsoIPackage.createPackageContents();



          theComHestonAdapterCon1RuntimeAsoIPackage.initializePackageContents();



          imfRuntime.registerPackage(theComHestonAdapterCon1RuntimeAsoIPackage);

          LOGGER.log(Level.FINE, "Initialization of com.heston.adapter.con1.runtime.aso.AsoIPackage: exit 'init()'");
          return theComHestonAdapterCon1RuntimeAsoIPackage;
      }
    }
    ...
    */
    ...
    public com.informatica.imf.icore.IFactory getFactory() {
       return com.heston.adapter.con1.runtime.aso.AsoIFactory.I_INSTANCE;
    }
   ...
   private boolean isCreated = false;
    ...
    /**
     ...
     public void createPackageContents() {
         LOGGER.log(Level.FINE, "Initialization of com.heston.adapter.con1.runtime.aso.AsoIPackage: enter 'createPackageContents()'");
         if (this.isCreated) {
           LOGGER.log(Level.FINE, "Initialization of com.heston.adapter.con1.runtime.aso.AsoIPackage: already created");
           return;
         }
         this.isCreated = true;
         ...
         LOGGER.log(Level.FINE, "Initialization of com.heston.adapter.con1.runtime.aso.AsoIPackage: exit 'createPackageContents()'");
    }
  private boolean isInitialized = false;
    ...
    public void initializePackageContents() {
        LOGGER.log(Level.FINE, "Initialization of com.heston.adapter.con1.runtime.aso.AsoIPackage: enter 'initializePackageContents()'");
      ...
      iSetIdentity(getQualifiedName());
        ...
        initClasses();
        setFactory(com.heston.adapter.con1.runtime.aso.AsoIFactory.I_INSTANCE);
        ...
        LOGGER.log(Level.FINE, "Initialization of com.heston.adapter.con1.runtime.aso.AsoIPackage: exit 'initializePackageContents()'");
    }
